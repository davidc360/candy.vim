...
let s:colors = {
  \ "red": get(s:color_store, "red", { "gui": "#ff79c6", "cterm256": "168"}),
  \ "purple": get(s:color_store, "purple", { "gui": "#ce7af5", "cterm256": "176"}),
  \ "yellow": get(s:color_store, "yellow", {'gui': '#ffce5b', 'cterm256': '178'}),
  \ "cyan": get(s:color_store, "cyan", {'gui': '#4da2db', 'cterm256': '153'}),
  \ "green": get(s:color_store, "green", {'gui': '#2cda9d', 'cterm256': '157'}),
  \ "white": get(s:color_store, "white", {'gui': '#efeeea', 'cterm256': '254'}),
  \ "black": get(s:color_store, "black", {'gui': '#2a2e38', 'cterm256': '232'}),
